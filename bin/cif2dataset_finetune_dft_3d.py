# -*- coding: utf-8 -*-
# @Author : liang
# @File : cif2dataset_finetune_dft_3d.py
...
def convert(args):
    ...
    mbj_bandgap_list = []
    optb88vdw_bandgap_list = []
    optb88vdw_total_energy_list = []
    ehull_list = []
    ...
    for atoms in tqdm(dataset):
        ...
        id_list.append(atoms['jid'])

        formation_energy_list.append(atoms['formation_energy_peratom'])
        mbj_bandgap_list.append(atoms['mbj_bandgap'])
        optb88vdw_bandgap_list.append(atoms['optb88vdw_bandgap'])
        optb88vdw_total_energy_list.append(atoms['optb88vdw_total_energy'])
        ehull_list.append(atoms['ehull'])
    ...
    torch.save({'id': id_list,
                ...
                'formation_energy_peratom': formation_energy_list,
                'mbj_bandgap': mbj_bandgap_list,
                'optb88vdw_bandgap': optb88vdw_bandgap_list,
                'optb88vdw_total_energy': optb88vdw_total_energy_list,
                'ehull': ehull_list

                },
               args.save_path + str(args.dataset) + '_processed.pt')
...
def parse_args():
    parser = argparse.ArgumentParser(description='convert data to string adm graph')
