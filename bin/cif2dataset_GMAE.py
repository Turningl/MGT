...
def pyg2atoms(data):
    ...
    all_atoms_pos = data.gmae_pos
    all_atoms_cell = cell.Cell(data.cell.squeeze(0).numpy())
    all_atoms_number = data.gmae_atom_numb
    all_tags = data.gmae_tags
...
def convert(args):
    ...
    """
    dataset_path = os.path.join(args.dataset, 'data.lmdb')
    print(f"Loading the zipfile from {dataset_path}...")
    lmdb_data = LmdbDataset({"src": dataset_path})
    ...
    for atoms in tqdm(lmdb_data):
        ...
        sid = atoms.sid
        cif_path = os.path.join(args.dataset, "cif/", f'{sid}.cif')
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, help='path to atomistic data to convert',
                        default='/home/zl/DGM/dataset/Alloy-GMAE/raw/')
    # parser.add_argument('--dataset', type=str, help='path to atomistic data to convert',
    #                     default='/home/zl/DGM/dataset/FG-GMAE/raw/')
    # parser.add_argument('--dataset', type=str, help='path to atomistic data to convert',
    #                     default='/home/zl/DGM/dataset/OCD-GMAE/raw/')

    parser.add_argument('--save_path', type=str, help='path to atomistic data to convert',
                        default='/home/zl/DGM/dataset/finetune/processed/alloy_gmae_processed.pt')
    # parser.add_argument('--save_path', type=str, help='path to atomistic data to convert',
    #                     default='/home/zl/DGM/dataset/finetune/processed/fg_gmae_processed.pt')
    # parser.add_argument('--save_path', type=str, help='path to atomistic data to convert',
    #                     default='/home/zl/DGM/dataset/finetune/processed/ocd_gmae_processed.pt')
