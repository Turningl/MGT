# -*- coding: utf-8 -*-
# @Author : liang
# @File : cif2dataset_shear_muduli.py
...
def convert(args):
    ...
    ############################megnet######################################
    dataset1 = pd.read_pickle('/home/zl/DGM/dataset/finetuned/raw/shear_megnet_train.pkl')
    dataset2 = pd.read_pickle('/home/zl/DGM/dataset/finetuned/raw/shear_megnet_val.pkl')
    dataset3 = pd.read_pickle('/home/zl/DGM/dataset/finetuned/raw/shear_megnet_test.pkl')
    ...
    for atoms in tqdm(dataset):
        ...
        shear_list.append(atoms['shear modulus'].numpy().max())
    ...
    torch.save({'id': id_list,
               ...
               args.save_path + 'shear_moduli_processed.pt')
