...
from models.so3_graph.atoms import SO3_GraphEncoder, SO3_ProjectionHead
from models.se3_graph.layers import SE3_GraphEncoder, SE3_ProjectionHead
...
class DGModel(nn.Module):
    ...
    """
    Double Graph Multi-modal Transformer (DGM)
